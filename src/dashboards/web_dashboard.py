    ...
    return html.Div(
        [
            ...
            html.P(
                ...
                style={"color": COLORS["text_secondary"], "margin": 0, "fontSize": "14px"},
            ),
        ],
        style=HEADER_STYLE,
    )
    ...
    return html.Div(
        [
            html.Div(
                kpi_card(
                    "Fleet Health Score",
                    f"{_demo_kpis.avg_health_score}%",
                    "Avg across all machines",
                    "accent_green",
                ),
            ...
            html.Div(
                kpi_card(
                    "Machines at Risk",
                    str(_demo_kpis.machines_at_risk),
                    f"of {_demo_kpis.total_machines} total",
                    "accent_red",
                ),
                style={"flex": "1", "minWidth": "200px"},
            ),
            html.Div(
                kpi_card(
                    "Annual Savings",
                    f"${_demo_kpis.estimated_annual_savings:,.0f}",
            ...
            html.Div(
                kpi_card(
                    "ROI",
                    f"{_demo_kpis.roi_percentage:.0f}%",
            ...
            html.Div(
                [
                    ...
                    html.Div(
                        [
                            html.Label(
                                "Maintenance At Cycle",
                                style={"color": COLORS["text_secondary"], "fontSize": "13px"},
                            ),
                            dcc.Input(
                                id="whatif-maint-cycle",
                                type="number",
                                value=180,
                                min=1,
                                max=500,
    ...
    def run_whatif(
        ...
        return html.Div(
            [
                ...
                html.P(
                    f"💰 Expected savings: ${s.expected_savings:,.0f}",
                    style={"color": color, "fontWeight": "600", "fontSize": "16px"},
                ),
                html.P(
                    f"{'✅ Recommended' if s.is_recommended else '❌ Not recommended'}",
                    style={"color": color},
                ),
            ]
        )
...
if __name__ == "__main__":
    ...
    dashboard_app.run(host="0.0.0.0", port=8050, debug=True)  # noqa: S104
